# ============================================================================
# Outputs for Encryption and Compliance Monitoring
# ============================================================================
...
# ============================================================================
# Azure Policy Assignments Outputs
# ============================================================================
...
output "azure_policy_assignments" {
  ...
  value = {
    ...
    encryption_initiative  = azurerm_subscription_policy_assignment.sql_encryption_initiative.name
  }
}
