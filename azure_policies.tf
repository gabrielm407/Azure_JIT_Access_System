...
resource "azurerm_subscription_policy_assignment" "sql_tde_enabled" {
  ...
  policy_definition_id = "/subscriptions/${var.ARM_SUBSCRIPTION_ID}/providers/Microsoft.Authorization/policyDefinitions/17k78e20-9358-41c9-923c-fb736d3e48ce"
  ...
  # Set enforcement mode to "Audit" for initial compliance review, then change to "Default" for enforcement
  not_scopes = []
}
...
resource "azurerm_subscription_policy_assignment" "sql_encryption_at_rest" {
  ...
  subscription_id   = "/subscriptions/${var.ARM_SUBSCRIPTION_ID}"
  policy_definition_id = "/subscriptions/${var.ARM_SUBSCRIPTION_ID}/providers/Microsoft.Authorization/policyDefinitions/7698e800-9299-47a6-966f-8a8a4edd3f82"
...
resource "azurerm_subscription_policy_assignment" "sql_cmk_encryption" {
  ...
  subscription_id   = "/subscriptions/${var.ARM_SUBSCRIPTION_ID}"
  policy_definition_id = "/subscriptions/${var.ARM_SUBSCRIPTION_ID}/providers/Microsoft.Authorization/policyDefinitions/0a370ff3-6cab-4e85-8995-295fd854dee7"
...
resource "azurerm_subscription_policy_assignment" "sql_firewall_rules" {
  ...
  subscription_id   = "/subscriptions/${var.ARM_SUBSCRIPTION_ID}"
  policy_definition_id = "/subscriptions/${var.ARM_SUBSCRIPTION_ID}/providers/Microsoft.Authorization/policyDefinitions/896822ca-2e6e-4df6-a60e-a38deedd2fbd"
...
resource "azurerm_subscription_policy_assignment" "sql_encryption_initiative" {
  ...
  subscription_id     = "/subscriptions/${var.ARM_SUBSCRIPTION_ID}"
  policy_definition_id = "/providers/Microsoft.Authorization/policySetDefinitions/055aa869-bc98-4af8-baaf-86c8b6696289"
